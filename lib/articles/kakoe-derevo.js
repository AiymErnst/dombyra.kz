  ...
  content: {
    ru: [
      ...
      },
      {
        ...
        description:
          "Цена зависит не от дизайна, а от мастера, дерева и дополнительных украшений. Наши мастера имеют опыт работы от 10 лет, а старший мастер изготавливает домбры с 1998 года. Профессиональная домбра никогда не изготавливается из одной породы дерева — каждая часть решает свою задачу, поэтому для неё подбирается своё дерево.",
        statPercent: {
          value: "80%",
    ...
    kz: [
      ...
      },
      {
        ...
        description:
          "Баға дизайнға емес, шеберге, ағашқа және қосымша әшекейлерге байланысты. Шеберлеріміздің тәжірибесі 10 жылдан бастап, ал бас шебер домбыра жасаумен 1998 жылдан бері айналысады. Кәсіби домбыра ешқашан бір тұқымнан жасалмайды — әр бөлік өз міндетін атқарады, сондықтан оған өз ағашы таңдалады.",
        statPercent: {
          value: "80%",
    ...
    en: [
      ...
      },
      {
        ...
        description:
          "The price doesn't depend on the design, but on the master, the wood, and any extra decorations. Our masters have at least 10 years of experience, and our senior master has been making dombras since 1998. A professional dombra is never made from a single type of wood — each part has its own job, so its own wood is chosen for it.",
        statPercent: {
          value: "80%",
    ...
    tr: [
      ...
      },
      {
        ...
        description:
          "Fiyat tasarıma değil, ustaya, ağaca ve ek süslemelere bağlıdır. Ustalarımızın deneyimi en az 10 yıldan başlar, baş ustamız ise 1998'den beri dombra yapmaktadır. Profesyonel bir dombra asla tek bir ağaç türünden yapılmaz — her parça kendi görevini üstlenir, bu yüzden her biri için ayrı bir ağaç seçilir.",
        statPercent: {
          value: "%80",
